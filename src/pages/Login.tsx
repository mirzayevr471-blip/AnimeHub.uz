...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // The popup handles the state via message post
    } catch (err: any) {
        ...
        >
          ...
          <div className="relative z-10">
            <div className="mb-10 text-center">
              ...
              <h1 className="text-3xl font-black tracking-tight mb-2">Tizimga kirish</h1>
              <p className="text-gray-500 text-sm font-medium">Sizni yana ko'rganimizdan xursandmiz!</p>
            </div>
            ...
            <div className="mt-10 pt-8 border-t border-white/5 text-center">
              <p className="text-sm text-gray-500 font-medium">
                Akkauntingiz yo'qmi?{' '}
                <Link to="/signup" className="text-blue-400 font-bold hover:text-blue-300 transition-colors">Ro'yxatdan o'tish</Link>
              </p>
            </div>
          </div>
        </motion.div>
