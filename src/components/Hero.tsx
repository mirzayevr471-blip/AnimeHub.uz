  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="relative bg-[#070709] rounded-[40px] overflow-hidden border border-white/5 py-12 md:py-20 px-8 md:px-16 lg:px-24">
        ...
        <div className="absolute bottom-[20%] left-[10%] w-3 h-3 bg-red-400 rounded-full blur-[4px] opacity-30"></div>
        <div className="absolute top-[10%] right-[30%] w-2 h-2 bg-purple-500 rounded-full blur-[3px] opacity-50"></div>
        <div className="absolute bottom-[10%] left-[55%] w-3 h-3 bg-yellow-600 rounded-full blur-[5px] opacity-40"></div>
        <div className="absolute top-[60%] right-[10%] w-4 h-4 bg-pink-600 rounded-full blur-[8px] opacity-30"></div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex-1 max-w-2xl">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-6">
                {currentAnime.genres[0] && (
                  <span className="px-5 py-2 rounded-full border border-red-500/20 bg-[#111] text-red-500 text-[10px] font-black uppercase tracking-widest shadow-[0_0_15px_rgba(239,68,68,0.05)]">
                    {currentAnime.genres[0]}
                  </span>
                )}
            ...
            <div className="w-full max-w-[300px] sm:max-w-[340px] lg:max-w-[380px] xl:max-w-[420px] aspect-[3/4] flex-shrink-0 relative group">
              ...
              <div className="absolute inset-4 bg-white/20 blur-[50px] rounded-full group-hover:bg-red-500/20 transition-colors duration-700"></div>
          ...
          {heroSlides.map((_, index) => (
            <button
              ...
              className={`transition-all duration-300 rounded-full ${
                index === currentSlide 
                  ? 'w-6 h-1.5 bg-red-600 shadow-[0_0_10px_rgba(239,68,68,0.5)]' 
